define('modules/js/main', function(require, exports, module) {
  ...
  var Slide = {
    init: function (op) {
      require(['modules/js/swiper'], function (Swiper) {
  ...
  var Show = {
    init:function(ele,close,overlay){
      require(['components/zepto/main','components/zepto/touch'],function($,tap){
        $(ele).tap(function(){
  ...
  var Offcanvas ={
    init: function(trigger,drawer){
      require(['components/zepto/zepto','modules/js/drawer'],function($, draw){
        $(trigger).drawer({
          "model": $(drawer),
          "dimens": {
          "width": "50%"
